    ...
    */
    Route::prefix('/f/{family}')
        ...
        ->group(function () {
            ...
            Route::get('/bills/{bill}/edit', [FamilyBillsController::class, 'edit'])->name('family.bills.edit');
            Route::put('/bills/{bill}', [FamilyBillsController::class, 'update'])->name('family.bills.update');
